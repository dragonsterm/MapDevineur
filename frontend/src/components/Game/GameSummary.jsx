...
function GameSummary({ totalScore, rounds }) {
  ...
  // =========================================================================
  // MASTER BUTTON STYLE
  // Style konsisten (transparan + border tipis)
  // =========================================================================
  const masterButtonStyle = "min-w-[200px] px-8 py-4 rounded-lg bg-[#ffffff10] hover:bg-[#ffffff20] border border-white/5 transition-all text-sm font-bold uppercase tracking-widest text-gray-300 hover:text-white hover:border-white/20 active:scale-95 flex items-center justify-center gap-3 cursor-pointer backdrop-blur-md";
        ...
        {!showBreakdown ? (
          ...
          <div className="animate-fade-in-up flex flex-col items-center gap-4 w-full">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center w-full md:w-auto">
              ...
              {/* Play Again juga kembali ke /game karena user menyebut /game adalah menu utama */}
              <Link to="/game" className={masterButtonStyle}>
                <IconRefresh className="w-5 h-5" />
                <span>PLAY AGAIN</span>
              </Link>

              {/* PERBAIKAN: Link ke /game sesuai permintaan (tembus ke game.jsx) */}
              <Link to="/game" className={masterButtonStyle}>
          ...
          <div className="animate-fade-in flex flex-col items-center w-full max-w-6xl mx-auto">
            ...
            {/* TABEL - STYLE LEADERBOARD */}
            <div className="w-full bg-[#050505] border border-[#333] shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden">
              <table className="w-full border-collapse">
                
                {/* HEADER TABEL */}
                <thead>
                  <tr className="bg-[#0a0a0a] text-gray-400 uppercase text-sm tracking-widest border-b border-[#333]">
                    ...
                    return (
                      <tr key={index} className="hover:bg-[#111] transition-colors">
                        ...
                        <td className="py-6 px-4 text-center">
                          ...
                          <span className="text-sm text-gray-500 ml-2 font-bold uppercase">PTS</span>
                        </td>
